...
class Parent_add extends CI_Controller {
    ...
    public function index() {
        ...
        $data['page_title'] = "Parent Registration";
        $data['page_slogan'] = "SMS";
        $data['main_content'] = "pages/parent/add";
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            foreach ($_POST as $key => $value) {
              ...
              if (!$this->upload->do_upload('picture')) {
                ...
                $data1['server_msg'] = $this->upload->display_errors('<p class="text-white">', '</p>');
            } else {
