...
<!-- Content Header (Page header) -->
  ...
  <?php echo $page_title; ?>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('student'); ?>"><i class="fa fa-user-md"></i> Teacher</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
       ...
       var frm = document.getElementsByName('change_password')[0];
        ...
        $.ajax({
            url: '<?php echo base_url('teacher/edit/'.$profile->id."/change_password") ?>',
            type: 'post',
            data: formData,
            dataType: 'json',
             async: true,
       ...
       var frm = document.getElementsByName('update_profile')[0];
        ...
        $.ajax({
            url: '<?php echo base_url('teacher/edit/'.$profile->id."/update") ?>',
            type: 'post',
            data: formData,
            dataType: 'json',
             async: true,
         ...
         <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-book margin-r-5"></i> Subject</strong>
