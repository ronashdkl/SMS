...
<section class="content container-fluid">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <form  name="form_teacher" id="form_teacher"  enctype="multipart/form-data" method="post" accept-charset="utf-8">
  ...
  <div class="form-group has-feedback">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="form-group right">
                            <button  type="submit" class="btn btn-flat btn-github">Add Teacher</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    $('#form_teacher').submit(function (e) {
    
        e.preventDefault();
        var me = new FormData($(this)[0]);
       var frm = document.getElementsByName('form_teacher')[0];
       
        $.ajax({
            url: '<?php echo base_url(); ?>teacher/add/post',
            type: 'post',
            data: me,
            dataType: 'json',
             async: true,
